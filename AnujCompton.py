...
#CSV_PATH = str(BASE_DIR / "eventset.csv")
#SAVE_DIR = "Results/Transformer/Trans07_processed_result"
...
MAX_EVENTS = 3000   # pad/truncate per source to this many events
...
def main():
    ...
    callbacks = [
        keras.callbacks.EarlyStopping(monitor="val_loss", patience=7, restore_best_weights=True),  # changed from 15 -> 7
